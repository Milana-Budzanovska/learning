  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-blue-100 to-purple-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        >
          <img src="/visual-icon.png" alt="Візуал" className="mx-auto w-20 mb-4" />
        ...
        >
          <img src="/audio-icon.png" alt="Аудіал" className="mx-auto w-20 mb-4" />
        ...
        >
          <img src="/touch-icon.png" alt="Кінестетик" className="mx-auto w-20 mb-4" />
