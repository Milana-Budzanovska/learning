  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-blue-100 to-purple-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/1000043625-removebg-preview.png`} alt="Візуал" className="mx-auto w-20 mb-4" />
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/IMG_20250307_010159_215.png`} alt="Аудіал" className="mx-auto w-20 mb-4" />
        ...
        >
          <img src={`${process.env.PUBLIC_URL}/1000043681-fotor-bg-remover-20250312224319.png`} alt="Кінестетик" className="mx-auto w-20 mb-4" />
